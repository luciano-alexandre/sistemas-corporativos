...
- Preparar a Prática 2 do encontro 08.

## Ponto de partida

Continue no projeto do encontro 06. Ele deve executar NestJS e PostgreSQL pelo
...
O encontro 06 criou tabelas com `synchronize`. Para gerar uma linha de base
...
## Exercício preparatório para o encontro 08
...
Esses elementos formam a base da Prática 2 do encontro 08.
